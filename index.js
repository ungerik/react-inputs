...
/***/ function(module, exports, __webpack_require__) {
	...
	var FloatInput = _react2["default"].createClass({
		...
		getInitialState: function getInitialState() {
			return { show_confirm: false };
		},

		render: function render() {
			return _react2["default"].createElement("input", { type: "number", min: "0", inputmode: "numeric", pattern: "[0-9]*", title: "Non-negative integral number", disabled: this.props.disabled });
		}
	});
